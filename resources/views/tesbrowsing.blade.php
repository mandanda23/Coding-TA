    ...
    <section class="home-section" style=" height: auto;">
        ...
        <main>
            ...
            <div class="row mt-3 ms-2 me-2">
                <?php $i = 0;?>
                @foreach ($isi['rowPerKecamatan'] as $perKecamatan)
                    @foreach ($perKecamatan as $item)
                        <div class="col-lg-3 mb-3" style="width: 350px">
                            <div class="card">
                                <div class="card-body">
                                    <h2 class="card-title" style="text-align: center">{{ $i+1 }}.
                                        {{ str_replace('http://www.semanticweb.org/Bali/PuraKahyanganJagat.owl#', '', $item[0]->kabupaten) }}
                                    </h2>
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <a href="{{ $isi['link'] }}/{{ str_replace('http://www.semanticweb.org/Bali/PuraKahyanganJagat.owl#', '', $item[0]->kabupaten) }}"
