...
<html lang="en">
  ...
  <script>
    const dashboard = document.querySelectorAll('.pura');
    dashboard.forEach((pura, i) => {
      pura.dataset.aos = 'zoom-out-up';
      pura.dataset.aosDelay = i * 50;
      pura.dataset.aosDuration = 800;
    })
